...
3. `ddc_onset`: Neural network structs mapped to full native ONNX runtime (`PlacementCNN`), `util.rs` port eliminates SciPy dependencies for peak finding. `constants.rs` fully mapped.
